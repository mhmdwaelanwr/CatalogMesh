...
class App:
    ...
    def build(self):
        ...
        try:
            ...
            pass
        ttk.Label(about_card,text="CATALOG OPERATIONS WORKSPACE",style="MetricName.TLabel").pack(anchor="w")
        ttk.Label(about_card,text="CatalogMesh",style="Metric.TLabel").pack(anchor="w",pady=(6,0))
